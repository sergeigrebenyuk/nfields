...
//	if (!current_set) 
	{wglMakeCurrent(m_pCDC->GetSafeHdc(), m_hRC); current_set = true;}
...
// as above a space separated list of extensions	str.gluextensions=(char*)::gluGetString(GLU_EXTENSIONS);
